...
const objLat = (obj) => {
    ...
    let info= `my name is ${obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1)} ${obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1)} I am ${obj.age} YO, and I love ${obj.hobby}.`
return info
};
// -------------------------------------------------------------------------------------------------------
...
const cvFormatter = (arr) => {
  ...
  for(let i=0; i<arr.length; i++){
    ...
    if (cv.yearsOfExperience>1){
      let fullName = cv.firstName&&cv.lastName? `${cv.firstName} ${cv.lastName}`: cv.firstName || cv.lastName;
      let tech = cv.tech
