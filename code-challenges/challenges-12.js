...
const oddFiltration = (arr) => {
    ...
    const output = arr.filter(value => value % 2 !== 0);
    return output
}
// -------------------------------------------------------------------------------------------------------
...
const cvsFiltration = (arr) => {
    // write your code here
    let filteredArr = arr.filter (cv => 
        cv.yearsOfExperience > 4 && cv.tech == 'JS');
        let cvs = filteredArr.map(cv=> ( {fullName:`${cv.firstName || ''} ${cv.LastName || ''}`.trim(),tech: cv.tech} )  );
    return cvs;
    }
// -------------------------------------------------------------------------------------------------------
...
const vowelsFiltration = (arr) => {
    // write your code 
    let regex= /[aeiou]/i
    let notVowel = arr.filter(x=>!regex.test(x));
    return notVowel
}
// -------------------------------------------------------------------------------------------------------
